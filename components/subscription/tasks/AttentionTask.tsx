...
export default function AttentionTask({ task, language, onComplete, isCompleted, onNextTask, onPreviousTask, canGoNext = false, canGoPrevious = false }: AttentionTaskProps) {
