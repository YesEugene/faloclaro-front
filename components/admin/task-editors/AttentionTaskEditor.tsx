...
export default function AttentionTaskEditor({ task, onChange, lessonDay }: AttentionTaskEditorProps) {
  ...
  // Update items when task changes
  useEffect(() => {
        ...
        >
          <div className="flex items-center gap-3 flex-1">
            ...
            <div className="flex flex-col gap-1 flex-1">
              <span className="font-bold text-gray-900">Проверка внимательности</span>
          ...
          <div className="border-t border-gray-200 bg-gray-50 p-4 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <textarea
                  value={feedback.ru || ''}
                  onChange={(e) => handleUpdateItem(index, 'feedback', { ...feedback, ru: e.target.value })}
              ...
              <div>
                ...
                <textarea
                  value={feedback.en || ''}
                  onChange={(e) => handleUpdateItem(index, 'feedback', { ...feedback, en: e.target.value })}
