...
export default function SubscriptionLandingPage() {
  ...
  const translations = {
    ...
    ru: {
      ...
      aboutSubtitle: 'После двух лет жизни в Португалии я понял, что хочу остаться, а значит, язык все-таки придется выучить. Как всегда, времени мало из-за работы, поэтому нужен был онлайн-формат. Но не «школа», а практика, чтобы говорить и действительно прочувствовать язык.',
