...
### Этап 1: Подготовка
1. ✅ Экспортировать существующие уроки в YAML файлы (backup)
...
### 6.3 Экспорт/Импорт
- Можно экспортировать урок в YAML (новая структура)
- Можно импортировать YAML в CRM
- Парсер понимает и старую, и новую структуру
