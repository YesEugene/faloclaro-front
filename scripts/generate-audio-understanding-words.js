/**
 * Generate audio for all words in "Making sense" cluster
 * that don't have audio_url yet
 * 
 * Usage:
 * node scripts/generate-audio-understanding-words.js
 */
...
async function main() {
  console.log('🚀 Starting audio generation for "Making sense" cluster...\n');
