/**
 * Generate audio for all short sentences in "Making sense" cluster
 * that don't have audio_url yet
 * 
 * Usage:
 * node scripts/generate-audio-understanding-short-sentences.js
 */
...
async function main() {
  console.log('🚀 Starting audio generation for "Making sense" cluster (short sentences)...\n');
