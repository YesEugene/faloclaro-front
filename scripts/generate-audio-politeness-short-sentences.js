/**
 * Generate audio for all short sentences in "Politeness and Requests" cluster
 * that don't have audio_url yet
 * 
 * Usage:
 * node scripts/generate-audio-politeness-short-sentences.js
 */
...
async function main() {
  console.log('🚀 Starting audio generation for "Politeness and Requests" cluster (short sentences)...\n');
