/**
 * Generate audio for all words in "My take" cluster
 * that don't have audio_url yet
 * 
 * Usage:
 * node scripts/generate-audio-reactions-words.js
 */
...
async function main() {
  console.log('🚀 Starting audio generation for "My take" cluster...\n');
