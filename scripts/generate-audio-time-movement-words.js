/**
 * Generate audio for all words in "Time and Path" cluster
 * that don't have audio_url yet
 * 
 * Usage:
 * node scripts/generate-audio-time-movement-words.js
 */
...
async function main() {
  console.log('🚀 Starting audio generation for "Time and Path" cluster...\n');
