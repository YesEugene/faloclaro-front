/**
 * Import short sentences from CSV file for "Speech Connectors" cluster
 * File: Короткие предложения.csv
 * 
 * Usage:
 * node scripts/import-speech-connectors-short-sentences.js
 */
...
const CATEGORIES_DIR = path.join(__dirname, '../Categories/10. Связки и структура речи');
...
// Main function
async function main() {
  console.log('🚀 Starting import for "Speech Connectors" cluster (short sentences)...\n');

  // Get cluster
  console.log('🔍 Finding "Speech Connectors" cluster...');
