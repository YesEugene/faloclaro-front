/**
 * Generate audio for all words in "Politeness and Requests" cluster
 * that don't have audio_url yet
 * 
 * Usage:
 * node scripts/generate-audio-politeness-words.js
 */
...
async function main() {
  console.log('🚀 Starting audio generation for "Politeness and Requests" cluster...\n');
