/**
 * Generate audio for all words in "Children and School" cluster
 * that don't have audio_url yet
 * 
 * Usage:
 * node scripts/generate-audio-children-school-words.js
 */
...
async function main() {
  console.log('🚀 Starting audio generation for "Children and School" cluster...\n');
