/**
 * Generate audio for all words in "Home and Daily Life" cluster
 * that don't have audio_url yet
 * 
 * Usage:
 * node scripts/generate-audio-home-daily-words.js
 */
...
async function main() {
  console.log('🚀 Starting audio generation for "Home and Daily Life" cluster...\n');
