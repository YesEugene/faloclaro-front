/**
 * Generate audio for all short sentences in "Conflict and Discontent" cluster
 * that don't have audio_url yet
 * 
 * Usage:
 * node scripts/generate-audio-profanity-short-sentences.js
 */
...
async function getCluster() {
  ...
  if (error || !cluster) {
    console.error('❌ Cluster "Conflict and Discontent" not found:', error);
    process.exit(1);
  }
...
async function main() {
  console.log('🚀 Starting audio generation for "Conflict and Discontent" cluster (short sentences)...\n');
