/**
 * Delete all phrases and audio files for "Shops and Services" cluster
 * 
 * Usage:
 * node scripts/delete-shops-services-phrases.js
 */
...
async function deleteShopsServicesPhrases() {
  try {
    ...
    // Get all phrases for this cluster
    ...
    console.log(`📋 Found ${phrases?.length || 0} phrases to delete`);
    ...
    console.log(`✅ Successfully deleted ${phrases.length} phrases and their translations`);
    console.log(`✅ Deleted ${audioFiles.length} audio files from storage`);
