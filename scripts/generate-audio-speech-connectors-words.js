/**
 * Generate audio for all words in "Speech Connectors" cluster
 * that don't have audio_url yet
 * 
 * Usage:
 * node scripts/generate-audio-speech-connectors-words.js
 */
...
async function main() {
  console.log('🚀 Starting audio generation for "Speech Connectors" cluster...\n');
