/**
 * Generate audio for all short sentences in "Emotions and States" cluster
 * that don't have audio_url yet
 * 
 * Usage:
 * node scripts/generate-audio-emotions-short-sentences.js
 */
...
async function main() {
  console.log('🚀 Starting audio generation for "Emotions and States" cluster (short sentences)...\n');
