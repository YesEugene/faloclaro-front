/**
 * Generate audio for all short sentences in "Home and Daily Life" cluster
 * that don't have audio_url yet
 * 
 * Usage:
 * node scripts/generate-audio-home-daily-short-sentences.js
 */
...
async function main() {
  console.log('🚀 Starting audio generation for "Home and Daily Life" cluster (short sentences)...\n');
