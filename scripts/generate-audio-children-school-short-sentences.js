/**
 * Generate audio for all short sentences in "Children and School" cluster
 * that don't have audio_url yet
 * 
 * Usage:
 * node scripts/generate-audio-children-school-short-sentences.js
 */
...
async function main() {
  console.log('🚀 Starting audio generation for "Children and School" cluster (short sentences)...\n');
