/**
 * Generate audio for all short sentences in "My take" cluster
 * that don't have audio_url yet
 * 
 * Usage:
 * node scripts/generate-audio-reactions-short-sentences.js
 */
...
async function main() {
  console.log('🚀 Starting audio generation for "My take" cluster (short sentences)...\n');
