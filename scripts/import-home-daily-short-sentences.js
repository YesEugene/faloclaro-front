/**
 * Import short sentences from CSV file for "Home and Daily Life" cluster
 * File: Короткие предложения.csv
 * 
 * Usage:
 * node scripts/import-home-daily-short-sentences.js
 */
...
// Main function
async function main() {
  console.log('🚀 Starting import for "Home and Daily Life" cluster (short sentences)...\n');
