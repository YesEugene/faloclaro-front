/**
 * Upload audio files for Day 1 lesson Task 2 (Rules) to Supabase Storage
...
async function main() {
  console.log('🚀 Uploading audio files for Day 1 lesson Task 2 (Rules)...\n');
