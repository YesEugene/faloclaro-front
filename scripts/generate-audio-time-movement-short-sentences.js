/**
 * Generate audio for all short sentences in "Time and Path" cluster
 * that don't have audio_url yet
 * 
 * Usage:
 * node scripts/generate-audio-time-movement-short-sentences.js
 */
...
async function main() {
  console.log('🚀 Starting audio generation for "Time and Path" cluster (short sentences)...\n');
