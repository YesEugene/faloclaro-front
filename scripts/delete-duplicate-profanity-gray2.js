/**
 * Delete duplicate "Плохие слова / матерная речь" cluster (gray one) - new duplicate
 */
...
async function deleteDuplicate() {
  ...
  // ID нового дубля (русское название, серый цвет)
  const duplicateId = '90ab66e1-a23d-4094-8ad0-e593c04235ff';
